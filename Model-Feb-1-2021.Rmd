...
##
(399163 - sum(df2death$DEATHS)) / 51   # Feb 1, 2021
sum(df2death$DEATHS) + (mean((df2death$DEATHS)) * 51 ) ## Feb.1 , 2021(389087)
##
## 
```
...
ggplot(df2death) +geom_line(aes(x=Reported,y=MA7,col="7 Day MA"),lwd=2) + 
  ...
  labs(title="US Daily Predicted Deaths: Feb. 1, 2021",
       subtitle="Daily Avg (blue:1001) (Grenn: 2291/399163))"
       ,x="Date Reported",y="Daily Deaths") +
  geom_hline(yintercept=1001,lwd=1.5,col="blue") +
    geom_hline(yintercept=2291,lwd=1.5,col="green")
