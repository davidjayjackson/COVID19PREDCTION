...
#### Just COVID19 Deaths for Feb. 1, 2021: 399,163

```{r}
## 399163 by Feb. 1, 2021
#
(399163 - sum(df2death$new_deaths,na.rm = TRUE)) / 30  # Feb 1, 2021
sum(df2death$new_deaths,na.rm=TRUE) +  mean(df2death$new_deaths,na.rm = TRUE) *30
...
ggplot(df2death) +geom_line(aes(x=date,y=MA7,col="7 Day MA"),lwd=2) + 
  ...
  labs(title="US Daily Predicted Deaths: Feb. 1, 2021",
       subtitle="Daily Avg (blue:1133);Feb 1(Grenn: 1780/399163)"
       ,x="Date date",y="Daily Deaths") +
  geom_hline(yintercept=1133,lw=1.5,col="blue") +
    geom_hline(yintercept=1780,lwd=1.5,col="green")
