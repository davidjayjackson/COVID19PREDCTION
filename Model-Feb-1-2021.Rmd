...
#
(399163 - sum(df2death$new_deaths,na.rm = TRUE)) / 45  # Feb 1, 2021
sum(df2death$new_deaths,na.rm=TRUE) +  mean(df2death$new_deaths,na.rm = TRUE) *45
## 
```
...
ggplot(df2death) +geom_line(aes(x=date,y=MA7,col="7 Day MA"),lwd=2) + 
  ...
  labs(title="US Daily Predicted Deaths: Feb. 1, 2021",
       subtitle="Daily Avg (blue:1064);Feb 1(Grenn: 1966/399163)"
       ,x="Date date",y="Daily Deaths") +
  geom_hline(yintercept=1064,lwd=1.5,col="blue") +
    geom_hline(yintercept=1965,lwd=1.5,col="green")
