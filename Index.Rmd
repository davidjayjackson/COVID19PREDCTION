...
##
(399163 - sum(df1death$Deaths)) / 73 # Feb 1, 2021
...
ggplot(df1death) +geom_line(aes(x=Reported,y=Deaths),lwd=2,col="blue") + 
  ...
  labs(title="US Daily Total Deaths(2020-03-01 - 2020-11-21)",
       subtitle="Daily Avg (Red:952);Feb 1(Grenn: 1935/399163))"
       ,x="Date Reported",y="Daily Deaths") +
  geom_hline(yintercept=952,lwd=1.5,col="red") +
    geom_hline(yintercept=1982,lwd=1.5,col="green")
...
##
(438941 - sum(df1death$Deaths)) / 101  # Mar. 1, 2021
sum(df1death$Deaths) + (mean((df1death$Deaths)) * 101) ## Feb.1 , 2021(389087)
##
## 
```
```{r,echo=FALSE}
ggplot(df1death) +geom_line(aes(x=Reported,y=Deaths),lwd=2,col="blue") + 
  ...
  labs(title="US Daily Total Deaths(2020-03-01 - 2020-10-31)",
       subtitle="Daily Avg (Red:952);Mar. 1(Grenn: 1801/399163))"
       ,x="Date Reported",y="Daily Deaths") +
  geom_hline(yintercept=952,lwd=1.5,col="red") +
    geom_hline(yintercept=1827,lwd=1.5,col="green")
