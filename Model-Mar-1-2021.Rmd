...
#### Just COVID19 Deaths for Mar 1, 2021: 470,974

```{r}
## 399163 by Mar. 1, 2021
#
(470974 - sum(df2death$new_deaths,na.rm = TRUE)) / 66  # Feb 1, 2021
...
ggplot(df2death) +geom_line(aes(x=date,y=MA7,col="7 Day MA"),lwd=2) + 
  ...
  labs(title="US Daily Predicted Deaths: Mar. 1, 2021",
       subtitle="Daily Avg (blue:1064);Apr 1(Grenn: 2196/470974)"
       ,x="Date date",y="Daily Deaths") +
  geom_hline(yintercept=1064,lwd=1.5,col="blue") +
    geom_hline(yintercept=2196,lwd=1.5,col="green")
