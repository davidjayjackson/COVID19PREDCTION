...
#
(363269 - sum(df2death$new_deaths,na.rm = TRUE)) / 14  # Feb 1, 2021
sum(df2death$new_deaths,na.rm=TRUE) +  mean(df2death$new_deaths,na.rm = TRUE) *14
## 
```
...
ggplot(df2death) +geom_line(aes(x=date,y=MA7,col="7 Day MA"),lwd=2) + 
  ...
  labs(title="US Daily Predicted Deaths: Jan. 1, 2021",
       subtitle="Daily Avg (blue:1064);Feb 1(Grenn: 3755/363269)"
       ,x="Date date",y="Daily Deaths") +
  geom_hline(yintercept=1064,lwd=1.5,col="blue") +
    geom_hline(yintercept=3755,lwd=1.5,col="green")
